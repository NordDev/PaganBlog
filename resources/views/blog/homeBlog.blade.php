            ...
            <div class="col-xl-9 col-lg-8 col-md-7">
                ...
                <div class="blog-item">
                    ...
                    <div class="blog-text text-box text-white">
                        <div class="top-meta">11.11.18  /  in <a href="">Категория</a></div>
                        <h3>Название крутой статьи!</h3>
                        ...
                        <a href="#" class="read-more">Читать...  <img src="img/icons/double-arrow.png" alt="#"/></a>
                    </div>
                </div>
                <!-- Blog item -->
                <div class="blog-item">
            ...
            <div class="col-xl-3 col-lg-4 col-md-5 sidebar">
                <div id="stickySidebar">
                    <div class="widget-item">
                        <h4 class="widget-title">Лучшее</h4>
                        <div class="trending-widget">
                            <div class="tw-item">
                                ...
                                <div class="tw-text">
                                    <div class="tw-meta">11.11.18  /  in <a href="">Категория</a></div>
                                    <h5>Название крутой статьи!</h5>
                                </div>
                            </div>
                            <div class="tw-item">
                                <div class="tw-thumb">
